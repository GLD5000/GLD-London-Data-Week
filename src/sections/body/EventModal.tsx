...
export default function EventModal({
  ...
  return (
    <dialog
      ref={refPassed}
      id="event-modal"
      className="relative sm:w-fit w-screen h-screen sm:h-fit sm:rounded-3xl sm:border-2 sm:border-darkblue rounded-none bg-white text-darkblue m-auto py-12 px-6 sm:p-12"
    >
      <button
        ref={initialFocus}
        id="close-btn"
