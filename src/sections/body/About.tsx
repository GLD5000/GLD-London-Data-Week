...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className=" left-[85%] top-[25%] h-5 w-5 absolute dark:bg-lightgreen bg-darkgreen hover:scale-150 hover:transition -z-5 " />
      <div className=" left-[5%] top-[65%] h-6 w-6 absolute bg-pink hover:scale-150 hover:transition -z-5 " />
      <div className=" left-[15%] top-[64%] h-5 w-5 absolute dark:bg-lightgreen bg-darkgreen hover:scale-150 hover:transition -z-5 " />
