...
export default function Hero() {
  ...
  return (
    <section
      id="hero-section"
      ref={elementRef}
      className=" relative min-h-screen items-center lg:snap-start w-body-sm min-w-body max-w-body sm:w-body mx-auto "
    >
      <div className="flex h-full flex-col justify-between">
        <div className="h-fit grid gap-20 mt-32 ">
          ...
          <div className=" m-auto grid gap-8 sm:gap-16 text-center w-full fade-in">
            <p className=" text-3xl sm:text-[3.5rem] mx-auto w-fit font-bold ">July 3-9</p>
            <div className="text-3xl mx-auto text-center w-fit justify-center sm:text-[3.5rem] flex flex-row flex-wrap gap-2">
