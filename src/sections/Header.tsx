...
export default function Header({
  ...
  return (
    <header
      id="top"
      className="sticky top-0 left-0 right-0 z-[998] grid h-fit w-screen flex-shrink-0 flex-grow-0 grid-cols-frAutoFr content-center border-none border-border dark:border-border-dk bg-bg dark:bg-bg-dk"
    >
